...
insert into Airplane (Airplane_ID, Airline_name) values ('454033', 'Shanghai Global',2);

INSERT INTO airplane (Airplane_ID, Airline_name,Seats) VALUES ('454034', 'Shanghai Global',2);
INSERT INTO airplane (Airplane_ID, Airline_name,Seats) VALUES ('454035', 'Shanghai Global',2);
INSERT INTO airplane (Airplane_ID, Airline_name,Seats) VALUES ('454036', 'Shanghai Global',2);
...
insert into Flight (Flight_number, Airline_name, Arrival_Airport,Arrival_City,Arrival_date, Departure_Airport, Departure_City,Departure_date,Departure_hr, Departure_min, Arrival_hr, Arrival_min, Airplane_ID, Price, Status, Seats_Left) values ('3443', 'Shanghai Global', 'JFK',"New York",'2023-12-02', 'PVG', "Shanghai","2023-12-01", 19, 30, 2, 30, '454033', 500, 'Upcoming',2);


INSERT INTO Flight (Flight_number, Airline_name, Arrival_Airport, Arrival_City, Arrival_date, Departure_Airport, Departure_City, Departure_date, Departure_hr, Departure_min, Arrival_hr, Arrival_min, Airplane_ID, Price, Status, Seats_Left) 
VALUES ('3444', 'Shanghai Global', 'LAX', 'Los Angeles', '2023-12-02', 'PVG', 'Shanghai', '2023-12-01', 20, 30, 3, 30, '454034', 600, 'Upcoming',2);

INSERT INTO Flight (Flight_number, Airline_name, Arrival_Airport, Arrival_City, Arrival_date, Departure_Airport, Departure_City, Departure_date, Departure_hr, Departure_min, Arrival_hr, Arrival_min, Airplane_ID, Price,Status, Seats_Left) 
VALUES ('3445', 'Shanghai Global', 'ORD', 'Chicago', '2023-12-03', 'PVG', 'Shanghai', '2023-12-02', 21, 30, 4, 30, '454035', 700, 'Upcoming',2);

INSERT INTO Flight (Flight_number, Airline_name, Arrival_Airport, Arrival_City, Arrival_date, Departure_Airport, Departure_City, Departure_date, Departure_hr, Departure_min, Arrival_hr, Arrival_min, Airplane_ID, Price, Status, Seats_Left) 
VALUES ('3446', 'Shanghai Global', 'SEA', 'Seattle', '2023-12-04', 'PVG', 'Shanghai', '2023-12-03', 22, 30, 5, 30, '454036', 800, 'Upcoming', 2);
